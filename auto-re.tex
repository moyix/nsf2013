...
constructing an input that can pass all the transformations is pretty challenging. 
Based on the observation that such a program usually also contains the inverse transformations 
in order to support the bidirectional communication, we propose to use the program 
...
we plan to combine the high-level data buffer identification with the program module identification results together, 
and construct the data-buffer flow graph that is used to indicate which data buffers are flowing into which 
