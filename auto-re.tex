...
metadata~\cite{lee:ndss2011:tie}, identify vulnerabilities, harden existing
platforms~\cite{chipounov:asplos2011:s2e}, and even to automatically generate
...
In the following, we expound upon the project goals and scope, enumerate
specific research challenges that will be overcome, and summarize the
